...
<head>
    ...
    <meta name="description"
        content="AV Group offers luxurious apartments in Business Bay. Av Pearl  features fully furnished studios, 1 BHK, 2 BHK, 3 BHK, 4 BHK, and penthouses with premium amenities and views." />
    ...
    .page-title-bar {
        background: linear-gradient(0deg, rgba(23, 62, 98, 0.4), rgba(23, 62, 98, 0.4)), url(video/avpearl.mp4);
    }

    .page-title-bar {
        background: url(video/avpearl.mp4);
    }
    </style>
                                ...
                                <div class="elementor-widget-container">
                                                    ...
                                                    <li
                                                        ...
                                                        <li
                                                            ...
                                                            <li
                                                                ...
                                                                <a href=""
                                                                    class="elementor-sub-item">Mithila APT</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            ...
                                            <li
                                                ...
                                                <ul class="sub-menu elementor-nav-menu--dropdown">
                                                    <li
                                                        ...
                                                        <a href="https://maps.app.goo.gl/2Mhs9MqQX4WgLpgHA  "
                                    ...
                                    <nav class="elementor-nav-menu--dropdown elementor-nav-menu__container"
                                        ...
                                        <ul id="menu-2-63544e08" class="elementor-nav-menu">
                                            ...
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-19448">
                                                <a href="about-us.php" class="elementor-item" tabindex="-1">About us</a>
                                                <ul class="sub-menu elementor-nav-menu--dropdown">
                                                    <li
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-19449">
                                        ...
                                        <ul id="menu-main-menu" class="menu">
                                            ...
                                            <li
                                                ...
                                                <ul class="sub-menu">
                                                    <li
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17359">
                                                        <a href="https://maps.app.goo.gl/2Mhs9MqQX4WgLpgHA  ">Av map</a>
                                                    </li>
                                                    <li
                                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-65801">
            ...
            <div class="container">
                <div id="page-title-bar" class="page-title-bar ">
                    ...
                    <video autoplay loop id="myVideo" muted controls>
                        <source src="video/avpearl.mp4" type="video/mp4">
                    </video>
                    <!-- </div> -->
                        ...
                        <div data-dce-background-color="#F8F9FB"
                            ...
                            <div class="e-con-inner">
                                <div class="elementor-element elementor-element-94d3f30 datalayer-class elementor-widget elementor-widget-theme-post-title elementor-page-title elementor-widget-heading"
                                    ...
                                    <div class="elementor-widget-container">
                                        <h1 class="elementor-heading-title elementor-size-default">AV Pearl
                                        </h1>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="elementor-element elementor-element-25811b54 elementor-widget elementor-widget-text-editor"
                                                        ...
                                                        <div class="elementor-widget-container">
                                                            <div class="elementor-text-editor elementor-clearfix">
                                                                <p>Explore the world of AV pearl: Your home in the sky!
                                                                </p>
                                                                <p><span
                                                                        style="color: var( --e-global-color-secondary ); letter-spacing: 0.72px;">Imagine
                                                                        owning a piece of Virar's iconic skyline, with
                                                                        each morning greeted by stunning views of
                                                                        Mountains.</span><br>
                                                                </p>
                                                                <p><span
                                                                        style="color: var( --e-global-color-secondary ); letter-spacing: 0.72px;">AV
                                                                        Pearl by AV Group, the crown jewel of Av Group
                                                                        Properties, turns this dream into reality. Every
                                                                        detail is crafted for sophistication, from the
                                                                        fully furnished homes with premium Italian
                                                                        furniture to the exclusive.</span><br></p>
                                                                <p><span
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        <div class="elementor-image-box-wrapper elementor-button-">
                                                            ...
                                                            <div class="elementor-image-box-content">
                                                                ...
                                                                <p class="elementor-image-box-description">200+</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="dce-acf-repeater-grid">
                                                        ...
                                                        <div class="dce-acf-repeater-item"><span
                                                            ...
                                                            <h6 class="repeater-item elementor-repeater-item-4a85c44">3
                                                                Mins<br />Business Virar station</h6>
                                                        </div>
                                                        <div class="dce-acf-repeater-item"><span
                                                                class="repeater-item elementor-repeater-item-88a3160"><img
                                                        ...
                                                        <div class="col-6 col-lg-4 border-right border-down">
                                                            <div
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <h6>2 mins<br />Business Bay Canal</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6 col-lg-4 border-right border-down">
                                                            <div
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <h6>3 Mins<br />Business Virar Station</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6 col-lg-4 border-right border-down">
                                    ...
                                    <div class="elementor-widget-wrap elementor-element-populated">
                                        <div class="elementor-element elementor-element-187c6bc elementor-hidden-mobile elementor-widget elementor-widget-shortcode"
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="palaraxx-effect-section">
                                                    <div style="background-image: url(image/avpearlvivanta.jpeg)"
                                                        class="pageBlock">
                                                        <h5>Exterior</h5>
                                                    </div>
                                                </div>
                                                <div class="palaraxx-effect-section">
                                                    <div style="background-image: url(image/avpearl.jpg)"
                                                        class="pageBlock">
                                                        <h5>Side View</h5>
                                                    </div>
                                                </div>
                                                <div class="palaraxx-effect-section">
                                                    <div style="background-image: url(https://danubeproperties.com/wp-content/uploads/2024/09/3.jpg)"
                                                        class="pageBlock">
                                                        <h5>Lift Lobby</h5>
                                                    </div>
                                                </div>
                                                <div class="palaraxx-effect-section">
                                                    <div style="background-image: url(image/avpearlkk.jpeg)"
                                                        class="pageBlock">
                                                        <h5>Exterior</h5>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="elementor-element elementor-element-c809221 elementor-hidden-desktop elementor-hidden-tablet elementor-widget elementor-widget-shortcode"
                                            ...
                                            <div class="elementor-widget-container">
                                                ...
                                                <div class="palaraxx-effect-section">
                                                    <div style="background-image: url(https://danubeproperties.com/wp-content/uploads/2024/09/4-2.jpg)"
                                                        class="pageBlock">
                                                        <h5>Lift Lobby</h5>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="elementor-image-carousel-wrapper swiper" dir="ltr">
                                                    <div class="elementor-image-carousel swiper-wrapper swiper-image-stretch"
                                                        ...
                                                        <div class="swiper-slide" role="group"
                                                            ...
                                                            <figure class="swiper-slide-inner"><img
                                                                    class="swiper-slide-image swiper-lazy"
                                                                    data-src="image/gallary.jpeg" alt="2" />
                                                                <div class="swiper-lazy-preloader"></div>
                                                            </figure>
                                                        </div>
                                                        <div class="swiper-slide" role="group"
                                                        ...
                                                        <div class="swiper-slide" role="group"
                                                            ...
                                                            <figure class="swiper-slide-inner"><img
                                                                    class="swiper-slide-image swiper-lazy"
                                                                    data-src="image/table.jpeg" alt="5" />
                                                                <div class="swiper-lazy-preloader"></div>
                                                            </figure>
                                                        </div>
                                                        <div class="swiper-slide" role="group"
                                                            ...
                                                            <figure class="swiper-slide-inner"><img
                                                                    class="swiper-slide-image swiper-lazy"
                                                                    data-src="image/bedroom.jpeg" alt="34" />
                                                                <div class="swiper-lazy-preloader"></div>
                                                            </figure>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="elementor-custom-embed">
                                            <iframe loading="lazy"
                                                ...
                                                title="AV Pearl by AV Group Properties - Al Mustaqbal Street - Dubai - United Arab Emirates"
                                                aria-label="AV Pearl by AV Group Properties - Al Mustaqbal Street - Dubai - United Arab Emirates"></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="elementor-widget-container">
                                                ...
                                                <nav class="elementor-nav-menu--dropdown elementor-nav-menu__container">
                                                    <ul id="menu-dropdow-1-d5e5f1a" class="elementor-nav-menu">
                                                        <li
                                                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17099">
                                                            <a href="about-us.php" class="elementor-item">Company Profile</a>
                                                        </li>
                                                        <li
                                                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17100">
                                            ...
                                            <div class="elementor-widget-container">
                                                ...
                                                <nav class="elementor-nav-menu--dropdown elementor-nav-menu__container">
                                                    <ul id="menu-dropdow-1-4ad4d13" class="elementor-nav-menu">
                                                        ...
                                                        <li
                                                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-65801">
                                                            <a href="https://maps.app.goo.gl/2Mhs9MqQX4WgLpgHA  ">AV
                                                                Map</a>
                                                        </li>
                                                ...
                                                <nav class="elementor-nav-menu--mobile-enable elementor-nav-menu--main elementor-nav-menu__container elementor-nav-menu--layout-vertical e--pointer-none"
                                                    ...
                                                    <ul id="menu-footer-support" class="elementor-nav-menu sm-vertical">
                                                        <li
                                                            ...
                                                            <a href="a" class="elementor-item"><span
                                                        ...
                                                        <div id="elementor-tab-content-5493"
                                                            ...
                                                            <ul id="menu-menu-footer-1"
                                                                ...
                                                                <li
                                                                    ...
                                                                    <a href="https://d125.vvelocity.com/admin/index.php  "
                                                                        class="elementor-item"><span
                                                                            class="menu-title">Company Portal</span>
                                                                    </a>
                                                                </li>
                                                            </ul>
                ...
                <ul id="offcanvas-menu" class="offcanvas-menu menu menu-canvas-default">
                    ...
                    <li
                        ...
                        <ul class="sub-menu">
                            ...
                            <li
                                class="menu-item menu-item-type-post_type menu-item-object-osf_portfolio menu-item-16119">
                                <a href="avsmart.php" class="elementor-sub-item" tabindex="-1">Av
                                    Smart-City</a>
                            </li>
                        </ul>
                    </li>
                ...
                <li
                    ...
                    <ul class="sub-menu">
                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17359"><a
                                href="https://maps.app.goo.gl/2Mhs9MqQX4WgLpgHA ">Av Map</a></li>
