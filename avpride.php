...
<head>
    ...
    <title>AV Group - Apartments for Sale in Business Mumbai</title>
    <meta name="description"
        content="AV Group offers luxurious apartments . Av Pearl  features fully furnished studios, 1 BHK, 2 BHK, 3 BHK, 4 BHK, and penthouses with premium amenities and views." />
    <link rel="canonical" href="image/1LOGOS.PNG" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="AV Group - Apartments for Sale in Business umbai" />
    ...
    .page-title-bar {
        background: linear-gradient(0deg, rgba(23, 62, 98, 0.4), rgba(23, 62, 98, 0.4)), url(video/AV Pride Drone.mp4);
    }

    .page-title-bar {
        background: url(video/AV Pride Drone.mp4);
    }
                                                    ...
                                                    <li
                                                        ...
                                                        <ul class="sub-menu elementor-nav-menu--dropdown">
                                                            ...
                                                            <li
                                                                ...
                                                                <a href="" class="elementor-sub-item">Av Ashirwad</a>
                                                            </li>
                                                            <li
                                            ...
                                            <li
                                                ...
                                                <ul class="sub-menu elementor-nav-menu--dropdown">
                                                    <li
                                                        ...
                                                        <a href="https://maps.app.goo.gl/2pVy16TZGcJSWK1D7"
                                        ...
                                        <ul id="menu-main-menu" class="menu">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li
                                                        ...
                                                        <ul class="sub-menu">
                                                            ...
                                                            <!-- <li class="menu-item menu-item-type-post_type menu-item-object-osf_portfolio menu-item-18766"><a href="" class="elementor-sub-item" tabindex="-1">z</a></li> -->
                                                            <li
                                                                class="menu-item menu-item-type-post_type menu-item-object-osf_portfolio menu-item-16965">
                                                                <a href="" class="elementor-sub-item"
                                                                    tabindex="-1">Mithila
                                            ...
                                            <li
                                                ...
                                                <ul class="sub-menu">
                                                    <li
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17359">
                                                        <a href="https://maps.app.goo.gl/2pVy16TZGcJSWK1D7">Av map</a>
                                                    </li>
                                                    <li
                                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-65801">
            ...
            <div class="container">
                <div id="page-title-bar" class="page-title-bar ">
                    ...
                    <video autoplay loop id="myVideo" muted controls>
                        <source src="video/AV Pride Drone.mp4" type="video/mp4">
                    </video>
                    <!-- </div> -->
                        ...
                        <div data-dce-background-color="#F8F9FB"
                            ...
                            <div class="e-con-inner">
                                <div class="elementor-element elementor-element-94d3f30 datalayer-class elementor-widget elementor-widget-theme-post-title elementor-page-title elementor-widget-heading"
                                    ...
                                    <div class="elementor-widget-container">
                                        <h1 class="elementor-heading-title elementor-size-default">AV Pride
                                        </h1>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="elementor-element elementor-element-25811b54 elementor-widget elementor-widget-text-editor"
                                                        ...
                                                        <div class="elementor-widget-container">
                                                            <div class="elementor-text-editor elementor-clearfix">
                                                                <p>Explore the world of AV Pride: Your home in the sky!
                                                                </p>
                                                                <p><span
                                                                        style="color: var( --e-global-color-secondary ); letter-spacing: 0.72px;">Placed
                                                                        towards the northern fringes of Mumbai,
                                                                        Nalasopara West is an emerging residential
                                                                        destination particularly for those seeking
                                                                        affordable housing options and want to remain
                                                                        well-connected with the main Mumbai
                                                                        city.</span><br>
                                                                </p>
                                                                <p><span
                                                                        style="color: var( --e-global-color-secondary ); letter-spacing: 0.72px;">AV
                                                                        A key suburb in Palghar district, Nalasopara
                                                                        West is strategically located along the Western
                                                                        Line of Mumbai suburban railway network and is
                                                                        bordered by Nalasopara East, Virar West, Virar
                                                                        East, Vasai East and Vasai West. It falls under
                                                                        the jurisdiction of Vasai-Virar Municipal
                                                                        Corporation.This region has witnessed consistent
                                                                        real estate development over time and comprises
                                                                        a blend of completed as well as
                                                                        under-construction apartment projects,
                                                                        especially within the affordable
                                                                        segment.</span><br></p>
                                                                <p><span
                                                                        style="color: var( --e-global-color-secondary ); letter-spacing: 0.72px;">
                                                                        Some of the residential complexes here include
                                                                        Deep Heights, DGS Sheetal Deep Complex, Reliable
                                                                        Heights, Orange Heights and Sanskruti Heights,
                                                                        among several others.</span><br></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="elementor-element elementor-element-39eb14d elementor-align-center elementor-button-primary elementor-widget elementor-widget-button"
                                                                ...
                                                                <div class="elementor-widget-container">
                                                                    <div class="elementor-button-wrapper">
                                                                        <a href="avpridever.p/avpridever.php"
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        <div class="elementor-image-box-wrapper elementor-button-">
                                                            ...
                                                            <div class="elementor-image-box-content">
                                                                ...
                                                                <p class="elementor-image-box-description">956</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div data-dce-background-color="#FFFFFF"
                            ...
                            <div class="e-con-inner">
                                ...
                                <div class="elementor-element elementor-element-5c03bed elementor-widget__width-initial elementor-widget-mobile__width-initial elementor-widget elementor-widget-text-editor"
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="elementor-text-editor elementor-clearfix">Set in the heart of
                                            Business Av Group, distinguished by its high-rises, stylish apartments,
                                            corporate
                                            offices, and luxury hotels – Av Pearl stands tall as a landmark. Positioned
                                            in proximity to Jivdani Road and a mere three-minutes from the Business
                                            Virar station, you can enjoy world-class shopping, exquisite dining, and
                                            endless entertainment at your doorstep.</div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="dce-acf-repeater-grid">
                                                        ...
                                                        <div class="dce-acf-repeater-item"><span
                                                            ...
                                                            <h6 class="repeater-item elementor-repeater-item-4a85c44">10
                                                                Mins<br />Nallasopara station</h6>
                                                        </div>
                                                        <div class="dce-acf-repeater-item"><span
                                                                class="repeater-item elementor-repeater-item-88a3160"><img
                                                                    src="https://danubeproperties.com/wp-content/uploads/2024/09/central-mall.png"
                                                                    alt="" /></span>
                                                            <h6 class="repeater-item elementor-repeater-item-4a85c44">25
                                                                mins<br />jivdani Temple</h6>
                                                        </div>
                                                        <div class="dce-acf-repeater-item"><span
                                                                class="repeater-item elementor-repeater-item-88a3160"><img
                                                        ...
                                                        <div class="col-6 col-lg-4 border-right border-down">
                                                            <div
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <h6>10 Mins<br />Nallasopara Station</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6 col-lg-4 border-right border-down">
                                                            <div
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <h6>25 mins<br />jivdani Temple</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6 col-lg-4 border-right border-down">
                                    ...
                                    <div class="elementor-widget-wrap elementor-element-populated">
                                        <div class="elementor-element elementor-element-187c6bc elementor-hidden-mobile elementor-widget elementor-widget-shortcode"
                                            ...
                                            <div class="elementor-widget-container">
                                                ...
                                                <div class="palaraxx-effect-section">
                                                    <div style="background-image: url(image/pridegar.jpeg)"
                                                        class="pageBlock">
                                                        <h5>Gardan</h5>
                                                    </div>
                                                </div>
                                                <div class="palaraxx-effect-section">
                                                    <div style="background-image: url(image/prideplan.jpeg)"
                                                        class="pageBlock">
                                                        <h5>Upper View</h5>
                                                    </div>
                                                </div>
                                                <div class="palaraxx-effect-section">
                                                    <div style="background-image: url(image/poolpride.jpeg)"
                                                        class="pageBlock">
                                                        <h5>swiming pool</h5>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="elementor-image-carousel swiper-wrapper swiper-image-stretch"
                                                        ...
                                                        <div class="swiper-slide" role="group"
                                                            ...
                                                            <figure class="swiper-slide-inner"><img
                                                                    ...
                                                                    data-src="image/pridehall.jpeg" alt="1" />
                                                        ...
                                                        <div class="swiper-slide" role="group"
                                                            ...
                                                            <figure class="swiper-slide-inner"><img
                                                                    class="swiper-slide-image swiper-lazy"
                                                                    data-src="image/pridekitchen.jpeg" alt="2" />
                                                                <div class="swiper-lazy-preloader"></div>
                                                            </figure>
                                                        </div>
                                                        <div class="swiper-slide" role="group"
                                                            ...
                                                            <figure class="swiper-slide-inner"><img
                                                                    class="swiper-slide-image swiper-lazy"
                                                                    data-src="image/pridekit2.jpeg" alt="4" />
                                                                <div class="swiper-lazy-preloader"></div>
                                                            </figure>
                                                        </div>
                                                        <div class="swiper-slide" role="group"
                                                            ...
                                                            <figure class="swiper-slide-inner"><img
                                                                    class="swiper-slide-image swiper-lazy"
                                                                    data-src="image/pridebed1.jpeg" alt="5" />
                                                                <div class="swiper-lazy-preloader"></div>
                                                            </figure>
                                                        </div>
                                                        <div class="swiper-slide" role="group"
                                ...
                                <div class="elementor-element elementor-element-3396335 elementor-widget elementor-widget-google_maps"
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="elementor-custom-embed">
                                            <iframe loading="lazy"
                                                src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=av pride nallasopara west &amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                                                title="AV Pride BY AV Group Properties "
                                                aria-label="AV Pride BY AV Group Properties "></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="elementor-widget-container">
                                                ...
                                                <form action="mail.php" method="post">
                                                    ...
                                                    <div class="disclaimer">
                                                        Disclaimer:AV Properties values your privacy and will use the
                                                        contact information you provide solely for communicating with
                                                        you about our products and services. By clicking the submit
                                                        button, you consent to our sales agents contacting you via phone
                                                        calls, emails, and WhatsApp messages. You have the right to opt
                                                        out of these communications at any time. For more details,
                                        ...
                                        <div class="elementor-element elementor-element-1493560 dce_masking-none elementor-widget elementor-widget-image"
                                            ...
                                            <div class="elementor-widget-container">
                                                <img loading="lazy" width="645" height="648" src="image/1LOGOS.PNG"
                                                    ...
                                                    srcset="image/1LOGOS.PNG 645w, https://danubeproperties.com/wp-content/uploads/2024/03/skyline_get-in-touch-300x300.jpg 300w, https://danubeproperties.com/wp-content/uploads/2024/03/skyline_get-in-touch-150x150.jpg 150w"
                                            ...
                                            <div class="elementor-widget-container">
                                                ...
                                                <nav class="elementor-nav-menu--dropdown elementor-nav-menu__container">
                                                    <ul id="menu-dropdow-1-4ad4d13" class="elementor-nav-menu">
                                                        ...
                                                        <li
                                                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-65801">
                                                            <a href="https://maps.app.goo.gl/2pVy16TZGcJSWK1D7">AV
                                                                Map</a>
                                                        </li>
                                            ...
                                            <div class="elementor-widget-container">
                                                ...
                                                <nav class="elementor-nav-menu--dropdown elementor-nav-menu__container">
                                                    <ul id="menu-dropdow-1-10e624a" class="elementor-nav-menu">
                                                        <li
                                                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-13629">
                                                            <a href="/cdn-cgi/l/email-protection#4a29390a2e2b243f282f3a38253a2f383e232f39642b2f"
                                                                class="elementor-item">After Sales Support</a>
                                                        </li>
                                                        <li
                                                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-13630">
                                                            <a href="/cdn-cgi/l/email-protection#4c29223d39253e350c282d22392e293c3e233c293e3825293f622d29"
                                            ...
                                            <div class="elementor-widget-container">
                                                ...
                                                <nav class="elementor-nav-menu--dropdown elementor-nav-menu__container">
                                                    <ul id="menu-dropdow-1-8412795" class="elementor-nav-menu">
                                                        ...
                                                        <li
                                                            class="menu-item menu-item-type-post_type menu-item-object-osf_portfolio menu-item-18310">
                                                            <a href="avinfinity.php" class="elementor-item">Av
                                                                Infinity</a>
                                                        </li>
                                                        <li
                                                            class="menu-item menu-item-type-post_type menu-item-object-osf_portfolio menu-item-18307">
                                                    ...
                                                    <div class="elementor-toggle-item">
                                                        ...
                                                        <div id="elementor-tab-content-5495"
                                                            ...
                                                            <ul id="menu-menu-footer-5"
                                                                ...
                                                                <li
                                                                    class="menu-item menu-item-type-custom menu-item-object-custom">
                                                                    <a href="/cdn-cgi/l/email-protection#9ffcecdffbfef1eafdfaefedf0effINRebf6faecb1fefa"
                                                                        class="elementor-item"><span
                                                            ...
                                                            <ul id="menu-menu-footer-5"
                                                                ...
                                                                <li
                                                                    class="menu-item menu-item-type-custom menu-item-object-custom">
                                                                    <a href="/cdn-cgi/l/email-protection#9ffaf1eeeaf6ede6dffbfef1eafdfaefedf0effINRebf6faecb1fefa"
                                                                        class="elementor-item"><span
                ...
                <ul id="offcanvas-menu" class="offcanvas-menu menu menu-canvas-default">
                    <li
                        ...
                        <ul class="sub-menu">
                            <li
                                class="sub-menu-has-menu menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-17136">
                                <a href="#" class="elementor-sub-item elementor-item-anchor" tabindex="-1">Latest
                                    Launches</a>
                                <ul class="sub-menu">
                                    <li
                                        class="menu-item menu-item-type-post_type menu-item-object-osf_portfolio current-menu-item menu-item-29103">
                    ...
                    <li
                        ...
                        <ul class="sub-menu">
                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17359"><a
                                    href="https://maps.app.goo.gl/2pVy16TZGcJSWK1D7">Av Map</a></li>
    ...
    jQuery(document).ready(function($) {
        ...
        $(document).on('click', '.elementor-form .elementor-button', function(event) {
            ...
            if (errorMessage) {
                ...
                var pdfURL = 'pride.pdf'; // Replace with actual URL
                var link = document.createElement('a');
                link.href = pdfURL;
                link.download = 'pride.pdf'; // Specify the file name for download
                link.click();
